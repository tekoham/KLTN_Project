...
const CreateCollectionSelected = ({ onCreateColletion, onChange, value, listOfCollections }) => {
    ...
    return (
        <div className="create-nft-collections">
            <div className="create-nft-collections_item" onClick={onCreateColletion}>
                <img className="create-nft-collections_item__icon" src={AddFilledIcon} />
            ...
            {listOfCollections?.map((item, index) => (
                ...
                >
                    ...
                    <Tooltip title={item?.name}>
                        <span className="create-nft-collections_item__title">{item?.name}</span>
                    </Tooltip>
                </div>
            ))}
        </div>
