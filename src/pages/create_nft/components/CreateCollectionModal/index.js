...
import { CustomButton, InputCustom, CustomInputTextarea, Label } from '../../../../components/common'
            ...
            <Form form={form} onFieldsChange={removeError}>
                    ...
                    <Label title="Collection symbol">
                        <Form.Item
                            ...
                            rules={[
                                ...
                                {
                                    max: 10,
                                    message: 'Display collection symbol cannot exceed 10 characters'
                                }
                            ]}
                        >
                ...
                <div className="create-collection_block">
                    <Label title="Description">
                        ...
                        >
                            <CustomInputTextarea rows={4} placeholder="Enter description (optional)" />
                        </Form.Item>
                    </Label>
                </div>
                ...
                {isFormError && <p className="create-collection-fix-all-error">Please fix all errors above</p>}
            </Form>
        </Modal>
    )
}
