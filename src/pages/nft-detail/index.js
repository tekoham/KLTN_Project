...
const NFTDetail = props => {
    ...
    useEffect(() => {
        if (listData?.type == 'auction' && listData?.expireDate && listData?.expireDate - currentTime > 0) {
                                ...
                                {listData?.description?.length != 0 ? (
                                    isDescriptionOpen ? (
                                        <div>
                                            ...
                                            <div className="show-less" onClick={() => setIsDescriptionOpen(false)}>
                                                Show less
                                            </div>
                                        </div>
                                    ) : (
                                        <div>
                                            ...
                                            <div className="show-more" onClick={() => setIsDescriptionOpen(true)}>
                                                Show more
                                            </div>
                                        </div>
                                    )
                                            ...
                                            {listData?.type == 'auction' ? (
                                                <div className="price-container d-flex justify-content-space-between">
                                                    ...
                                                    <div className="price-content">
                                                        ...
                                                        <div className="highest-bids">{listData?.price} ETH</div>
                                                    </div>
                                                </div>
                                            ) : (
                                                <div className="price-container">
                                                    <div className="price-content">
                                                        ...
                                                        <div className="fixed-price">{listData?.price} ETH</div>
                                                    </div>
                                                </div>
                                            )}
                                        </div>
                                        <CustomButton className="buy-btn" color="pink-hover-blue" shape="small-radius">
