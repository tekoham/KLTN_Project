...
const FIXED_PRICE_CONTRACT_ADDRESS = process.env.REACT_APP_SMART_CONTRACT_FIXED_PRICE
const AUCTIONS_CONTRACT_ADDRESS = process.env.REACT_APP_SMART_CONTRACT_AUCTIONS
const COLLECTION_FACTORY_CONTRACT_ADDRESS = process.env.REACT_APP_SMART_CONTRACT_COLLECTION_FACTORY
...
export const genCollectionContract = collection_address => {
    return getContractInstanceEther(CollectionAbi, collection_address)
}
