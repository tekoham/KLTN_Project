...
import Logo from '../../../../assest/image/logo-full.png'
...
const Header = () => {
    ...
    return (
        <div className="header-container d-flex">
            ...
            <div>
                <Link to="/create">
                    <CustomButton color="charcoal-blue" display="inline" className="create-btn">
                        Create
                    </CustomButton>
                </Link>
                {myProfile?.data?.address ? (
                    ...
                    >
                        <CustomTooltip title={myProfile?.data?.address} placement="left">
                            <CustomButton color="pink" display="inline" className="address-btn">
